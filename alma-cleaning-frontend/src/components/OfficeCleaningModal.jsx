...
const OfficeCleaningModal = ({ isOpen, onClose, onAddToMainCart, isMobile, isSmallMobile }) => {
  const [cartItems, setCartItems] = useState([]);

  const services = [
    { id: 'office-general', title: 'Генеральная уборка', price: 800, step: 10, min: 0 },
    { id: 'office-post-construction', title: 'Послестроительная уборка', price: 1000, step: 10, min: 0 },
    { id: 'office-maintenance', title: 'Поддерживающая уборка', price: 600, step: 10, min: 0 },
  ];
...
export default OfficeCleaningModal; 