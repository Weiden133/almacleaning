...
import covrolin from '../assets/covrolin.jpg';

const CarpetServicesModal = ({ isOpen, onClose, onAddToMainCart, isMobile, isSmallMobile }) => {
  const [cartItems, setCartItems] = useState([]);

  const services = [
    { id: 'carpet-sintetic', title: 'Синтетический ковер', price: 2000, image: covrolin, step: 1, min: 1 },
    { id: 'carpet-polusintetic', title: 'Полусинтетический ковер', price: 2500, image: covrolin, step: 1, min: 1 },
    { id: 'carpet-natural', title: 'Натуральный ковер', price: 3000, image: covrolin, step: 1, min: 1 },
  ];
...
export default CarpetServicesModal; 