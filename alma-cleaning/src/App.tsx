...
function App() {
  ...
  return (
    <div className="App">
      ...
      <section id="services" className="services-section container">
        ...
        <div className="services-grid">
          <div className="service-card">
            <div className="icon-wrapper" style={{'--icon-color': '#2a44c9'} as React.CSSProperties}>
          ...
          <div className="service-card">
            <div className="icon-wrapper" style={{'--icon-color': '#a855f7'} as React.CSSProperties}>
          ...
          <div className="service-card">
            <div className="icon-wrapper" style={{'--icon-color': '#ff0000'} as React.CSSProperties}>
          ...
          <div className="service-card">
            <div className="icon-wrapper" style={{'--icon-color': '#00c6fb'} as React.CSSProperties}>
          ...
          <div className="service-card">
            <div className="icon-wrapper" style={{'--icon-color': '#10b981'} as React.CSSProperties}>
          ...
          <div className="service-card">
            <div className="icon-wrapper" style={{'--icon-color': '#f59e0b'} as React.CSSProperties}>
      ...
      {/* Cart Modal */}
      <div id="cart" className={`cart-modal ${isCartOpen ? 'active' : ''}`}>
